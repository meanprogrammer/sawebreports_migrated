    ...
    public static class WhiteSpaceRemover
    {
        private static byte[][] GetRGB(Bitmap bmp)
        {
            ...
            int num_pixels = bmp.Width * bmp.Height,
                num_bytes = bmp_data.Stride * bmp.Height,
                padding = bmp_data.Stride - bmp.Width * 3,
                i = 0,
                ct = 1;

            byte[] r = new byte[num_pixels],
                g = new byte[num_pixels],
                b = new byte[num_pixels],
                rgb = new byte[num_bytes];
        ...
        public static Image AutoCrop(Bitmap bmp)
        {
            ...
            {
                int x = (i % (w)),
                    y = (int)(Math.Floor((decimal)(i / w))),
                    tol = 255 * tolerance / 100;
                ...
                else
                {
                    ...
                    right = (x == w - 1 && white == 0) ? w - 1 : right; white = 0;
                }
